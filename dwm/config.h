...
static const char col_lime[]        = "#9DBA3A";
...
static const Rule rules[] = {
	...
	{ "Firefox",          NULL,       NULL,       1 << 8,       0,           -1 },
        { "TelegramDekstop",  NULL,       NULL,       1 << 0,       0,           -1 },
};
...
#define SHCMD(cmd) { .v = (const char*[]){ "bin/sh", "-c", cmd, NULL } } // don't work(
...
static const char *vscode[]    = { "com.visualstudio.code", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,         {.v = pycharm} },
        ...
        { MODKEY|ShiftMask,             XK_v,      spawn,         {.v = vscode} },
